...
const PaymentHub: React.FC<PaymentHubProps> = ({ itemTitle, price, onSuccess, onClose }) => {
      ...
      <div className="bg-white w-full max-w-2xl rounded-[5rem] border-8 border-black shadow-[30px_30px_0px_0px_rgba(59,130,246,1)] p-12 md:p-20 relative overflow-hidden">
        ...
        {step === 'selection' && (
          <div className="space-y-12">
            <div className="space-y-4">
              <h2 className="text-6xl font-black uppercase tracking-tighter italic leading-none">Checkout Hub</h2>
        ...
        {step === 'processing' && (
          <div className="text-center py-20 space-y-12">
            ...
            <h3 className="text-5xl font-black uppercase italic animate-pulse">Communicating with Gateway...</h3>
